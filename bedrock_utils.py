...
# Categorizes user prompts to ensure it actually has to do with the subject of the information in the documents used for the Knowledge Base
...
# Transforms the user prompt for the similarity search with the vectors in the Knowledge Base
...
# Sends augmented prompt (original prompt + context) to the LLM to get the final answer
